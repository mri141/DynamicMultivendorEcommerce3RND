            ...
            <div class="col-5 text-right d-none d-lg-block">
                <ul class="list-inline mb-0 h-100 d-flex justify-content-end align-items-center">
                    ...
                    @else
                       ...
                       <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="https://sobkisubazar.com/shops/create" class="text-reset d-inline-block opacity-60 py-2">Be a Seller</a>
                        </li>
                        <li class="list-inline-item mr-3 border-right border-left-0 pr-3 pl-0">
                            <a href="https://sobkisubazar.com/users/registration" class="text-reset d-inline-block opacity-60 py-2">{{ translate('Be a Customer')}}</a>
                        </li> 
                    @endauth
                </ul>
            </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="col-auto col-xl-3 pl-0 pr-3 d-flex align-items-center">
                    <a class="d-block py-20px mr-3 ml-0" href="{{ route('home') }}">
                        ...
                        @endphp
                        @if($header_logo != null)
                            <img src="{{ uploaded_asset($header_logo) }}" alt="{{ env('APP_NAME') }}" class="mw-100 h-30px h-md-45px" height="40" >
                            <!--height="40"-->
                        @else
                ...
                <div class="flex-grow-1 front-header-search d-flex align-items-center " style="background-color:#149777">
                            ...
                            <div class="d-flex position-relative align-items-center">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="input-group-append d-none d-lg-block">
                                        <button class="btn btn-primary" type="submit" style="background-color:#F16722 !important;border-color:#F16722 !important;">
                    ...
                    <div class="" >
                     <li class="list-inline-item mr-0">
                        ...
                        <a href="{{ route('customer_products.create')}}">
                             <button style="color:#fff;background-color:#F16722 !important;border:0px;border-radius:20px;" type="button" class="btn btn-warning btn-rounded">Post Your Ads</button>
                        </a>
        ...
        <div class="bg-white border-top border-gray-200 py-1" style="background-color:#f16722 !important;">
            <div class="container">
                <ul class="list-inline mb-0 pl-0 mobile-hor-swipe text-center">
                    ...
                    <li class="list-inline-item mr-0">
                        <a style="color:#FFFFFF !important;opacity:10 !important;" href="{{ json_decode( get_setting('header_menu_links'), true)[$key] }}" class="opacity-60 fs-14 px-3 py-2 d-inline-block fw-600 hov-opacity-100 text-reset">
                            {{ translate($value) }}
                        </a>
                    </li>
